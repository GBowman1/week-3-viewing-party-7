...
RSpec.describe "User Registration" do
  ...
  it 'can create a user with a name, email, password, and password confirmation' do
    visit register_path

    fill_in :user_name, with: 'User One'
    fill_in :user_email, with:'user1@aol.com'
    fill_in :user_password, with: 'password123'
    fill_in :user_password_confirmation, with: 'password123'
  ...
  it 'does not create a user if password and password confirmation do not match' do
    ...
    fill_in :user_name, with: 'User One'
    fill_in :user_email, with:'usone@aol.com'
    fill_in :user_password, with: 'password123'
  ...
  it "does not create user if name is missing" do
  end
